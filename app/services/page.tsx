...
const services = [
    ...
    },
    {
        ...
        description:
        'We generate, test, and optimize ads using AI. Think infinite headlines, adaptive targeting, and ROI-driven performance.',
    ...
    },
    {
        ...
        description:
        'AI-generated copy, smart recommendations, and conversion-optimized pages — no templates, just data-driven design from GPT.',
    ...
    },
    {
        ...
        description:
        'Blogs into threads. Podcasts into landing pages. Raw ideas into polished campaigns. Fully customized content rewriters built per client.',
    ...
    },
    {
        ...
        description:
        'We build your AI co-pilot. Trained on your voice, docs, logic. Built to execute and improve autonomously.',
